...
def main() -> None:
    ...
    with sync_playwright() as playwright:
        ...
        assert "Find the cat" in page.locator(".mission-callout").text_content()
        ...
        click_and_wait(page, "#enable-mic", 150)
        voice_gate_question = page.locator("#gate-question").text_content()
        voice_gate_numbers = [int(value) for value in re.findall(r"\d+", voice_gate_question)]
        page.locator("#gate-answer").fill(str(sum(voice_gate_numbers)))
        ...
        assert "Good morning, Ms. Lee." in page.locator(".mission-callout").text_content()
        ...
        browser.close()
    print("E2E passed: legacy 8-level progress, School City unlock, parent report, and mobile layout.")
